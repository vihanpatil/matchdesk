...
| A4  | Date range and tenure arithmetic         | H-040 — triaged **wrong-score**: date format flips eligibility | **FINDING OPEN** (H-040)                                    |
...
finding.** Two rows do not — **A1 (H-041)** and **A4 (H-040)**, both open
wrong-score — and **A5 has never been run at all**. A8 was closed by the
2026-08-13 triage.

**A4 and A1 are the same shape** and plausibly share one remedy: the engine
emitting a confident number while silently discarding something it knows it
could not account for. Attack them together.
